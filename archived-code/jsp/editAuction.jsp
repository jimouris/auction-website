        ...
        <div class="one-half column">
            <section class="register u-full-width">
                ...
                <form action="executeNewAuction" method="POST" id="new_auction">
                    ...
                    <input class="u-full-width" type="text" id="aucName" name="aucName" minlength="2" required autofocus value='<%= title %>' />
                    ...
                    <input class="u-full-width" type="number" id="aucFirstBid" name="aucFirstBid" minlength="1" required value='<%= startingprice %>'>
